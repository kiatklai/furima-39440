  ...
  describe '配送先情報の保存' do
    ...
    context '配送先情報の保存ができないとき' do
      ...
      it '郵便番号が空だと保存できないこと' do
        @buyer_destination.post_code = nil
        @buyer_destination.valid?
        expect(@buyer_destination.errors.full_messages).to include("Post code can't be blank", "Post code is invalid. Include hyphen(-)")
      end
